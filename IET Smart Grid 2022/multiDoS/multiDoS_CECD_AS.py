...
iinj = pd.read_csv('../data csv files/IAT_dos4_multi_point1percent_noise_new.csv') # IAT Injection
tdinj = pd.read_csv('../data csv files/TD_dos4_multi_point1percent_noise_new.csv') # TD Injection
orz = pd.read_csv('../data csv files/orz_dos_multi.csv')
...
cm_title = "CECD-AS multiDoS Cross-layer" 
