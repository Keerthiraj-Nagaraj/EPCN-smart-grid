...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 31 14:41:41 2020
...
cm_title = "CECD-AS coord multiFDI 97 722 new IAT cv" 
...
stop_data_index = 12600 #21600 #12600
...
file_title = 'local csv files eta 11/result_table_coord_iat_CV.csv'
...
result_table_pd = pd.DataFrame(result_table)
result_table_pd.to_csv(file_title)

#%%

# result_table_pd = pd.DataFrame(rx_matrix)
# result_table_pd.to_csv(file_title + 'rx_mat_mfdi.csv')

# result_table_pd = pd.DataFrame(thr_matrix)
# result_table_pd.to_csv(file_title + 'thr_mat_mfdi.csv')


# result_table_pd = pd.DataFrame(y_pred)
# result_table_pd.to_csv(file_title + 'y_pred_mfdi.csv')

result_table_pd = pd.DataFrame(ecd_decision_scores)
result_table_pd.to_csv('local csv files eta 11/cecd_score_mfdi_iat_cv.csv')
