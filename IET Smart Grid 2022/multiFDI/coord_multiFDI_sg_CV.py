...
cm_title = "CECD-AS coord multiFDI 97 722 new SG cv" 
...
file_title = 'local csv files/result_table_coord_sg_CV.csv'
...
result_table_pd.to_csv('local csv files/cecd_score_mfdi_sg_cv.csv')
