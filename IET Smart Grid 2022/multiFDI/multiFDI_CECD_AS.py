...
iinj = pd.read_csv('../data csv files/IAT_inject5_multi_point1percent_noise_new.csv') # IAT Injection
tdinj = pd.read_csv('../data csv files/TD_inject5_multi_point1percent_noise_new.csv') # TD Injection
orz = pd.read_csv('../data csv files/orz_inj_multi.csv')

err_ins = pd.read_csv('../data csv files/err_ins_inj_multi.csv')
z = pd.read_csv('../data csv files/z_inj_multi.csv')
...
cm_title = "CECD-AS multiFDI Cross-layer" 
