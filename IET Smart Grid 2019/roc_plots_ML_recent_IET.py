...
plt.fill_between(mean_fpr_knn_1, tprs_lower_knn_1, tprs_upper_knn_1, color='grey', alpha=.8)
...
tprs_upper_knn_3 = np.minimum(mean_tpr_knn_3 + std_tpr_knn_3, 1)
tprs_lower_knn_3 = np.maximum(mean_tpr_knn_3 - std_tpr_knn_3, 0)
plt.fill_between(mean_fpr_knn_3, tprs_lower_knn_3, tprs_upper_knn_3, color='grey', alpha=.8)
...
tprs_upper_knn_5 = np.minimum(mean_tpr_knn_5 + std_tpr_knn_5, 1)
tprs_lower_knn_5 = np.maximum(mean_tpr_knn_5 - std_tpr_knn_5, 0)
plt.fill_between(mean_fpr_knn_5, tprs_lower_knn_5, tprs_upper_knn_5, color='grey', alpha=.8)
...
tprs_upper_nbayes = np.minimum(mean_tpr_nbayes + std_tpr_nbayes, 1)
tprs_lower_nbayes = np.maximum(mean_tpr_nbayes - std_tpr_nbayes, 0)
plt.fill_between(mean_fpr_nbayes, tprs_lower_nbayes, tprs_upper_nbayes, color='grey', alpha=.8)
...
tprs_upper_ada = np.minimum(mean_tpr_ada + std_tpr_ada, 1)
tprs_lower_ada = np.maximum(mean_tpr_ada - std_tpr_ada, 0)
plt.fill_between(mean_fpr_ada, tprs_lower_ada, tprs_upper_ada, color='grey', alpha=.8)
...
plt.fill_between(mean_fpr_svc, tprs_lower_svc, tprs_upper_svc, color='grey', alpha=.8)
...
tprs_upper_se = np.minimum(mean_tpr_se + std_tpr_se, 1)
tprs_lower_se = np.maximum(mean_tpr_se - std_tpr_se, 0)
plt.fill_between(mean_fpr_se, tprs_lower_se, tprs_upper_se, color='grey', alpha=.8)
...
plt.plot(mean_fpr_cdt, mean_tpr_cdt, color='cyan', label=r'CD Mean ROC (AUC = %0.2f $\pm$ %0.2f)' % (mean_auc_cdt, std_auc_cdt), lw=2, alpha=.8)

std_tpr_cdt = np.std(tprs_cdt, axis=0)
tprs_upper_cdt = np.minimum(mean_tpr_cdt + std_tpr_cdt, 1)
tprs_lower_cdt = np.maximum(mean_tpr_cdt - std_tpr_cdt, 0)
plt.fill_between(mean_fpr_cdt, tprs_lower_cdt, tprs_upper_cdt, color='grey', alpha=.8)
...
plt.plot(mean_fpr_ecd, mean_tpr_ecd, color='lime', label=r'ECD Mean ROC (AUC = %0.2f $\pm$ %0.2f)' % (mean_auc_ecd, std_auc_ecd), lw=2, alpha=.8)

std_tpr_ecd = np.std(tprs_ecd, axis=0)
tprs_upper_ecd = np.minimum(mean_tpr_ecd + std_tpr_ecd, 1)
tprs_lower_ecd = np.maximum(mean_tpr_ecd - std_tpr_ecd, 0)
plt.fill_between(mean_fpr_ecd, tprs_lower_ecd, tprs_upper_ecd, color='grey', alpha=.8,
...
plt.plot(mean_fpr_fused, mean_tpr_fused, color='b', label=r'Fused Mean ROC (AUC = %0.2f $\pm$ %0.2f)' % (mean_auc_fused, std_auc_fused), lw=2, alpha=.8)

std_tpr_fused = np.std(tprs_fused, axis=0)
tprs_upper_fused = np.minimum(mean_tpr_fused + std_tpr_fused, 1)
tprs_lower_fused = np.maximum(mean_tpr_fused - std_tpr_fused, 0)
plt.fill_between(mean_fpr_fused, tprs_lower_fused, tprs_upper_fused, color='grey', alpha=.8)
...
plt.savefig('ROC_IET_ML_comp_final.png', dpi = 600, bbox_inches="tight")
