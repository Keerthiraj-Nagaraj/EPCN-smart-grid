...
result_table_pd.to_csv('local csv files/attacked meas final/err_ins_FDI_rfdi_4_attack_len_50_sz_6sd_s4_sdval_2_trans_75.csv')

result_table_pd = pd.DataFrame(err_sz)
result_table_pd.to_csv('local csv files/attacked meas final/err_sz_FDI_rfdi_4_attack_len_50_sz_6sd_s4_sdval_2_trans_75.csv')

result_table_pd = pd.DataFrame(attacked_org_data[:, attack_meas_number])
result_table_pd.to_csv('local csv files/attacked meas final/original_attacked_rfdi_4_attack_len_50_sz_6sd_s4_sdval_2_trans_75.csv')

result_table_pd = pd.DataFrame(unmutated_orz[:, attack_meas_number])
result_table_pd.to_csv('local csv files/attacked meas final/mutated_attacked_and_then_decrypted_rfdi_4_attack_len_50_sz_6sd_s4_sdval_2_trans_75.csv')


#%%

plt.plot(attacked_org_data[8250:8400, attack_meas_number], '.')

#%%
plt.plot(attacked_mutated_data[8250:8400, attack_meas_number], '.')
#%%
plt.plot(unmutated_orz[8250:8400, attack_meas_number], '.')
...
etas = [4, 5]#[3,4,5] # 11, 12, 13] #[9] #gauss #[7, 8, 9, 10, 11, 12, 13]# ; [3, 4, 4.5, 5, 5.5, 6, 7]
...
hf.arr_to_csv(result_table_att, 
              csv_filename = 'local csv files/results ramp final/att_rfdi_1_attack_len_50_sz_6sd_s4_sdval_2_trans_75.csv')

hf.arr_to_csv(result_table_final, 
              csv_filename = 'local csv files/results ramp final/decrypt_rfdi_1_attack_len_50_sz_6sd_s4_sdval_2_trans_75.csv')
