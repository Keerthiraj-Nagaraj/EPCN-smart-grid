...
attacked_org_data_rfdi1 = hf.add_smartfdi_attacks(measurement_data = orz, err_size = err_sz, 
                                            err_ins = err_ins, add_val_to = 'meas', window_size = 50)     
...
attacked_org_data_rfdi2 = hf.add_smartfdi_attacks(measurement_data = orz, err_size = err_sz, 
                                            err_ins = err_ins, add_val_to = 'meas', window_size = 50)     
...
attacked_org_data_rfdi3 = hf.add_smartfdi_attacks(measurement_data = orz, err_size = err_sz, 
...
attacked_org_data_rfdi4 = hf.add_smartfdi_attacks(measurement_data = orz, err_size = err_sz, 
                                            err_ins = err_ins, add_val_to = 'mean', window_size = 50)     
...
fig, axs = plt.subplots(nrows = 3, ncols=2, sharex = True, figsize=(6,7))

ax = axs[0,0]

ax.plot(err_sz_linear[start_ind:stop_ind], '-', label = 'linear')
...
ax.plot(err_sz_smooth[start_ind:stop_ind], '-', label = 'smooth')
ax.set_xlabel('time sample #')
# ax.set_ylabel('Lambda')
ax.set_title('Smooth Ramp')
ax.legend()


ax = axs[1,0]

ax.plot(attacked_org_data_rfdi1[start_ind:stop_ind, 393], '.', label = 'RFDI-1')
ax.plot(orz[start_ind:stop_ind, 393], '.', label = 'true')
ax.set_xlabel('time sample #')
ax.set_ylabel('measurement value')
# ax.set_title('RFDI-1 smart attacks')
ax.legend()

ax = axs[1,1]

ax.plot(attacked_org_data_rfdi2[start_ind:stop_ind, 393], '.', label = 'RFDI-2')
ax.plot(orz[start_ind:stop_ind, 393], '.', label = 'true')
ax.set_xlabel('time sample #')
# ax.set_ylabel('measurement value')
# ax.set_title('RFDI-2 smart attacks')
ax.legend()


ax = axs[2,0]

ax.plot(attacked_org_data_rfdi3[start_ind:stop_ind, 393], '.', label = 'RFDI-3')
ax.plot(orz[start_ind:stop_ind, 393], '.', label = 'true')
ax.set_xlabel('time sample #')
ax.set_ylabel('measurement value')
# ax.set_title('RFDI-3 smart attacks')
ax.legend()

ax = axs[2,1]

ax.plot(attacked_org_data_rfdi4[start_ind:stop_ind, 393], '.', label = 'RFDI-4')
ax.plot(orz[start_ind:stop_ind, 393], '.', label = 'true')
ax.set_xlabel('time sample #')
# ax.set_ylabel('measurement value')
# ax.set_title('RFDI-4 smart attacks')
ax.legend()

plt.tight_layout(True)
plt.savefig('rfdi-attacks.png', dpi = 600)
